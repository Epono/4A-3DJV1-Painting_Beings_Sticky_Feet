...
{
	#region PluginInfo
	[PluginInfo(Name = "Templatetesttexture", Category = "EX9.Texture", Help = "Basic template which creates a texture", Tags = "")]
	#endregion PluginInfo
	public class EX9_TextureTemplatetesttextureNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
		...
		[Input("Handle", DefaultValue = 64, MinValue = 1)]
		public ISpread<int> FHandleIn;
		...
		Texture CreateTexture(Info info, Device device)
		{
			...
			System.IntPtr ptr = new System.IntPtr(FHandleIn[0]);
			return SlimDX.Direct3D9.Texture.FromPointer(ptr);
