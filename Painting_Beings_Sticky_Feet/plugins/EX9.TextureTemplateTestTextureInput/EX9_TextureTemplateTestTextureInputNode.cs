...
{
	#region PluginInfo
	[PluginInfo(Name = "TemplateTestTextureInput", Category = "EX9.Texture", Help = "Basic template which creates a texture", Tags = "")]
	#endregion PluginInfo
	public class EX9_TextureTemplateTestTextureInputNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
